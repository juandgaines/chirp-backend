...
class EmailRateLimiter (
    ...
    companion object {
        private const val EMAIL_RATE_LIMIT_KEY_PREFIX = "rate_limit:email"
        private const val EMAIL_ATTEMPT_COUNT_PREFIX = "email_attempts_count"
    }
    ...
    fun withRateLimit(
        ...
        val rateLimitKey = "$EMAIL_RATE_LIMIT_KEY_PREFIX:$normalizedEmail"
